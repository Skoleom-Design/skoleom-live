...
export default function WalletCheckoutPage() {
  ...
  return (
    <>
      <Head>
        <title>Recharger le wallet — skoleomLive</title>
      </Head>
        ...
        <div className="w-full max-w-sm">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <h1 className="text-xl font-bold text-white">Wallet rechargé</h1>
              <p className="text-white/45 text-sm">Le montant sera crédité dès validation du paiement.</p>
              <Link
                href="/profile/me"
            ...
            <>
              <h1 className="text-xl font-bold text-white mb-6 text-center">Recharger mon wallet</h1>
